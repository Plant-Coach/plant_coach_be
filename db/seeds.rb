...
plant1.garden_plants.create(planting_status: "not_started", start_from_seed: true)
plant2.garden_plants.create(planting_status: "not_started", start_from_seed: true)
plant3.garden_plants.create(planting_status: "not_started", start_from_seed: true)
plant4.garden_plants.create(planting_status: "not_started", start_from_seed: true)
plant5.garden_plants.create(planting_status: "not_started", start_from_seed: true)

user2_plant1.garden_plants.create(planting_status: "not_started", start_from_seed: true)
user2_plant2.garden_plants.create(planting_status: "not_started", start_from_seed: true)
